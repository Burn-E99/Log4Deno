...
---------------------------------------------------------------------------------------------------`;
  ...
  writeInterval = setInterval(writeLogs, writeLogTimer);
...
export const log = (level: LogTypes, message: string, error: boolean | Error = new Error()): void => {
